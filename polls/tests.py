...
class QuestionModelTests(TestCase):
    ...
    def test_future_pub_date(self):
        """
        is_published() should return False for a question with a future
        publication date.
        """
        future_question = create_question(
            question_text='Future question.', days=4
        )
        self.assertFalse(future_question.is_published())

    def test_default_pub_date(self):
        """
        is_published() should return True for a question with the default
    ...
    def test_past_pub_date(self):
        """
        is_published() should return True for a question with a past
        publication date.
        """
    ...
    def test_can_vote_when_within_voting_period(self):
        """
        Users can vote when within the specified voting period
        (pub_date <= current time <= end_date).
        """
        question = create_question(
            question_text='One day polls', days=-1, end_date=3
        )
    ...
    def test_cannot_vote_after_end_date(self):
        ...
        expired_question = create_question(
            question_text='Expired Question', days=-5, end_date=-1
        )
